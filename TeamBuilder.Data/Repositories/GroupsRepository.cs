...
internal class GroupsRepository(TeamBuilderDbContext context) : IGroupsRepository
{
    ...
    public Task<PagedResult<GroupEntity>> ListAsync(int page, int count)
    {
        return context.Groups.ToPagedResult(page, count);
    }
