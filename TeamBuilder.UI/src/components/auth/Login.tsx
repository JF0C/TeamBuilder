...
export const Login: FunctionComponent = () => {
  ...
  const loginState: LoginStateDto | null = loginStateParam
    ? JSON.parse(loginStateParam)
    : null;
  ...
  if (authState.user) {
    ...
    return (
      <div className="size-full flex flex-col justify-center items-center">
        ...
        <div>Logged in as {authState.user.playerName}</div>
        <div>
          <NavLink to={Paths.HomePath}>Back</NavLink>
        </div>
      </div>
    );
  }
